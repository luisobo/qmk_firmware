...
qk_tap_dance_action_t tap_dance_actions[] = {
  ...
  [TD_SHIFT_CAPS]   = ACTION_TAP_DANCE_DOUBLE(KC_LSHIFT, LM(2,2)),
  [TD_SHIFT_SELECT] = ACTION_TAP_DANCE_FN_ADVANCED(NULL,x_finished, x_reset)
...
[BASE] = LAYOUT_ergodox(
     ...
     KC_LSFT,          CTL_T(KC_Z),  KC_X,     KC_C,           KC_V,         KC_B,     LGUI(KC_Z),  
     LM(2, 2),         LGUI(KC_GRAVE),KC_CAPS, TD(TD_SHIFT_SELECT),        LM(2, 2),
                                                     KC_TRNS,  KC_TRNS,  
                                                               KC_HOME,  
     ...
     KC_TRNS,              KC_Y,           KC_U,     KC_I,     KC_O,   KC_P,               KC_QUOTE,  
...
[SYMB] = LAYOUT_ergodox(
     KC_GRAVE,KC_F1,KC_F2,KC_F3,KC_F4,KC_F5,KC_TRNS,
     KC_BSLASH,KC_EXLM,KC_AT,KC_LCBR,KC_RCBR,KC_UNDS,KC_TRNS,
     KC_TILD,KC_HASH,KC_DLR,KC_LBRACKET,KC_RBRACKET,KC_EQUAL,
     KC_PIPE,KC_PERC,KC_CIRC,KC_LPRN,KC_RPRN,KC_PLUS,KC_TRNS,
     KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,
     RGB_MOD,KC_TRNS,
     KC_TRNS,
 ...
 [MDIA] = LAYOUT_ergodox(
      ...
      LALT(LCTL(KC_LEFT)),LALT(LCTL(LGUI(KC_LEFT))),LALT(LCTL(LGUI(KC_DOWN))),LALT(LCTL(LGUI(KC_UP))),LALT(LCTL(LGUI(KC_RIGHT))),LALT(LCTL(KC_RIGHT)),LALT(LCTL(LGUI(KC_M))),
      KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,
